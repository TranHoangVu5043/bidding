...
//                var auction = a.findByIdForUpdate(conn, auctionId);
//                double curentPrice = auction.getCurrentPrice();
//                double expectedPrice = amount + increment;
//                assertEquals(curentPrice, expectedPrice, "Lỗi bot nhảy sai giá!!");
//                System.out.println(">>>[TEST PASSED]");
//            }catch (Exception e){
